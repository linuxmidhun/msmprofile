...
<p>• Stronger professional profile &amp; résumé preparation</p>
        ...
        <section>
          <div className="max-w-5xl mx-auto px-6 py-32 text-center">
            ...
            <p className="text-xl text-black/60 max-w-3xl mx-auto leading-relaxed mb-10">
...
{/* Contact Section */}
            <section className="text-center py-16 pt-10 font-sans mb-10">
                <p className="text-lg mb-3 text-gray-600">Bring WOB to Your Institution</p>
