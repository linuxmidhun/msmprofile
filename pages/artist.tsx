...
const artist = () => (
    <ContainerBlock>
        ...
        <div className="bg-[#F1F1F1] dark:bg-gray-900">
            <div className="pt-10 px-5 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
                {/* Social Buttons */}
                <div className="inline-flex flex-col">
                    ...
                    <div className="mt-4">
                        <div className="flex flex-row justify-start items-center ">
                            ...
                            <div className="text-sm text-gray-500 px-5 font-semibold md:text-justify relative overflow-hidden dark:text-gray-300">
...
2-2v-12c0-0.2 0-0.6-0.2-0.8z"></path>
                ...
                <div className="hidden md:block col-span-1 md:col-span-2">
                    <div className="group mb-4 hover:shadow-lg rounded-sm transition duration-200 relative border border-purple-200 dark:border-gray-700 w-full aspect-w-16 aspect-h-9 shadow-violet-900">
                        <iframe width="100%" height={450} className='rounded-sm' src="https://www.youtube.com/embed/EufxNy0OZlA" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
                    </div>
                </div>
                <div className="block md:hidden col-span-1 md:col-span-2">
                    {/* <h1 className="text-xl font-semibold text-gray-700 py-0 -mt-20 md:-mt-2 dark:text-gray-200">
                        My acting showreel
                    </h1> */}
                    <div className=' -mt-20'>
                        <div className="group mb-4 hover:shadow-lg rounded-sm transition duration-200 relative border border-purple-200 dark:border-gray-700 w-full aspect-w-16 aspect-h-9 shadow-violet-900">
                            <iframe width="100%" className='h-56 rounded-sm' src="https://www.youtube.com/embed/EufxNy0OZlA" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
                        </div>
                    </div>
                </div>
...
2-2v-12c0-0.2 0-0.6-0.2-0.8z"></path>
                ...
                <div className="col-span-1 md:col-span-3 -mt-20">
                    <h1 className="text-xl font-semibold font-mono text-gray-700 py-5 -mt-2 md:-mt-2 dark:text-gray-200">
                        My recent works
                    </h1>
                </div>
                <div className="col-span-1 md:col-span-3 -mt-20">
                                ...
                                <a key={index} href={'https://youtube.com/watch?v=' + item.url} target='_blank'>
                                    <div className=" group mb-4 transition duration-200 relative bg-slate-200  rounded-sm border border-cyan-200 dark:border-gray-700  w-full aspect-w-16 aspect-h-9">
                                        ...
                                        <div className='px-2 py-5'>
                                            ...
                                            <br /> */}
                                            <h1 className="text-sm x-5 font-semibold text-cyan-700 -mt-2 dark:text-gray-200">
                                                {item.title} &nbsp;<svg fill='currentColor' style={{ display: 'inline-block', marginTop: '-5px', width: '1em', height: '1em' }}
                                                    viewBox="0 0 50 50">
                                                    <path d="M36 24c-1.2 0-2 0.8-2 2v12c0 1.2-0.8 2-2 2h-22c-1.2
0-2-0.8-2-2v-22c0-1.2 0.8-2 2-2h12c1.2 0 2-0.8 2-2s-0.8-2-2-2h-12c-3.4
0-6 2.6-6 6v22c0 3.4 2.6 6 6 6h22c3.4 0 6-2.6
...
2-2v-12c0-0.2 0-0.6-0.2-0.8z"></path>
                                            ...
                                            <span className="text-sm font-semibold text-gray-700 -mt-2 dark:text-gray-200">
                                                {item.contentType}
                                            </span><br />
